...
/// @notice
/// @dev
contract AffiliateFacet is ReentrancyGuard{
    // Using App Storage
    AppStorage internal appStorage;

    event NewPurchase(address buyer, uint amount);
    event NewCampaign(uint campaignId, address owner, address nftAddress, uint[3] commissionRate);
